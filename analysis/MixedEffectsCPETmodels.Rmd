...
pr
plot(pr,ci.style = "ribbon",add.data = TRUE, residuals = FALSE, residuals.line = FALSE, dot.alpha = 0.3, dot.size = 1.6, jitter = 0.05, collapse.group = "intensity") + scale_x_continuous(breaks = c(1,2,3,4,5), limits = c(1,5))
